    ...
    public JSONObject getJSONStatisticsOfPlayerById(String id) {
        ...
        try {
            ...
            for (Object anArray : statsarray) {
                ...
                if (onePositionOfArray.get("name").equals("Stat.InfectedKilled.Total"))
                    statsToReturn.put("kills", onePositionOfArray.get("value"));
                ...
                } else if (onePositionOfArray.get("name").equals("Stat.GamesPlayed.Total"))
                    totalMatches = (long) onePositionOfArray.get("value");
            }
